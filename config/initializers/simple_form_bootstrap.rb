...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'form-group', error_class: 'has-danger' do |b|
    ...
    b.use :hint,  wrap_with: { tag: 'small', class: 'text-muted' } # Don't use .text-help here, since this will apply the error color which we dont want for the hint
  end
  ...
  config.wrappers :vertical_boolean, tag: 'div', class: 'from-group', error_class: 'has-danger' do |b|
    b.use :html5
    b.optional :readonly
