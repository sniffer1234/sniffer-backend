...
ActiveRecord::Schema.define(version: 20170726002011) do
  ...
  create_table "user_establishments", force: :cascade do |t|
    ...
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.index ["establishment_id"], name: "index_user_establishments_on_establishment_id", using: :btree
    t.index ["user_id"], name: "index_user_establishments_on_user_id", using: :btree
  end
